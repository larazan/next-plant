  ...
  return (
    <>
      <div class="w-full bg-gray-200">
        <div class=" mx-auto flex max-w-screen-lg flex-col items-center justify-center space-y-4 px-4 py-4 md:flex-row md:justify-start md:space-x-9 md:space-y-0 md:px-12 md:py-8 ">
          ...
          <div class="space-y-2 text-center md:w-1/2 md:text-left">
            <span class="text-2xl font-semibold">Carlijn</span>
            <p className="text-sm"> 
